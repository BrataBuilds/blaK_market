...
const ServiceCard: React.FC<ServiceCardProps> = ({ service, onClick }) => {
  ...
  return (
    <div
      onClick={onClick}
      className="bg-gray-800 rounded-lg p-6 shadow-lg hover:shadow-xl transition-all duration-300 cursor-pointer group border border-gray-700 hover:border-purple-500"
    >
